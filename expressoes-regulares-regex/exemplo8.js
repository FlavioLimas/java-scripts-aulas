...
var regExp = /<table><tr>(<td>\([0-9]{2}\) [0-9]{4,5}-?[0-9]{4}<\/td>)+<\/tr><\/table>/; // Expressão [0-9] representa que teremos numeros de 0 a 9 e {4,5} seria representação de 4 a 5 numeros; Expressão (<td>\([0-9]{2}\) [0-9]{4,5}-?[0-9]{4}<\/td>)+ significa que ()+ dentro dos parenteses há um grupo e o + que poderam haver mais 
