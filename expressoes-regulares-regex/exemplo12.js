...
Substituindo todos os itens da tabela com telefone.replace(regExp,"TELEFONE"));
*/

var regExp = /\(\d{2}\)\s\d{4,5}-?\d{4}/g; // Retorna o primeiro dos telefones informados na tabela abaixo
